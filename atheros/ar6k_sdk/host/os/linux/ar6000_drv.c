...
char *reg_file = "/system/lib/modules/reg_code";
#else
char *reg_file = NULL;
#endif

#ifdef SOFTMAC_USED
char *softmac_file = "/system/lib/modules/softmac";
#else
    ...
    //if (ar6000_readwrite_file("/sys/devices/platform/" MMC_MSM_DEV "/detect_change", 
      //                         NULL, buf, length) < 0) {
        /* fall back to polling */
		 AR_DEBUG_PRINTF("Bin4ry: X10 uses polling, skipped detect_change!\n");        
...
/* ATHENV */
    ...
    {   /*
         ...
         */
        char *argv[] = { "/system/lib/modules/athfwloader", NULL };
